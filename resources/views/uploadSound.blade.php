...
<head>
    ...
    <title>Enviar Áudio - playBR</title>
    <style>
...
<body>
    ...
    <div class="bg">
        <div class="upload-container">
            <h1>Enviar Áudio</h1>
            <form class="upload-form" id="sound-upload-form" action="{{ route('uploadSound') }}" method="post" enctype="multipart/form-data">
                @csrf
                <P>Título</p>
    ...
    <script>
        document.getElementById('sound-upload-form').addEventListener('submit', function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            var uploadModal = document.getElementById('uploadModal');
            uploadModal.style.display = 'flex';

            fetch("/api/sounds", { // Alterado para a rota de áudio
                method: 'POST',
                body: formData,
                headers: {
